...
module.exports = function(app){
    ...
    app.post('/saveTrafficStatus',site.saveTrafficStatus);  //TSP保存互动路况
    app.post('/trafficStatus',site.requesttrafficweibo);    //得到互动路况
    app.post('/refreshTraffic',site.refreshTrafficweibo);   //得到最新的互动路况
    app.post('/Anycast',site.requestanycast);            //选播一条【路况】/【留言】更改他的状态
